...
Link to all benchmarking code : [https://github.com/Chamodya-ka/traccc/tree/final](https://github.com/Chamodya-ka/traccc/tree/final)

Link to kernel benchmarking code : [https://github.com/Chamodya-ka/traccc/tree/final_kernel_benchmark](https://github.com/Chamodya-ka/traccc/tree/final_kernel_benchmark)
> note : vecmem contiguos memory resource reset function is not available hence if required to run for many events it is required to initialize contiguous memory resource with a large memory (>~4GB)
...
- [weekly report](https://docs.google.com/document/d/1Z1SDlntJEKGyttQQtsCJ07Yxbd--AZumA-uRR0vxfv0/edit#heading=h.n2i9f8dlgpv9)
- [presentation](https://docs.google.com/presentation/d/1B25KNt0whHr1pdXSTflYt5sfSGCpOVOMhDIEx66uCrY/edit?usp=sharing)
- [benchmarks](https://drive.google.com/drive/folders/1whXnW9HCPIOIPkGhHEf5wHyGUvMmgg_p?usp=sharing)
