...
Link to all benchmarking code : [final benchmark branch](https://github.com/Chamodya-ka/traccc/tree/final)

Link to kernel benchmarking code : [final kernel benchmark branch](https://github.com/Chamodya-ka/traccc/tree/final_kernel_benchmark)
