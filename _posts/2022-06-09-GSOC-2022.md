...
![image-to-mps]({{ site.url }}{{ site.baseurl }}/assets/Images/mulitple_processes.jpg){: .align-center}
...
<img src="{{ site.url }}{{ site.baseurl }}/assets/Images/profile_init.png" alt="" width="600">
